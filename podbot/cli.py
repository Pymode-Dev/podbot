...
def main():
    ...
    options = OrderedDict(
        {
            "sp": Options(DisplayPodcast()),
            "se": Options(DisplayEpisode(podcast_name)),
            "d": Options(DownloadEpisode(podcast_name, episode)),
            "delete": Options(DeleteFeed(podcast_name)),
            "add": Options(AddFeed(podcast_name, url_feed)),
        }
    )
    clear_screen()
